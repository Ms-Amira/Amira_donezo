//Put code here for the middleware to authenticate User requests if they have the token and check if it's a legit token// Import the `jsonwebtoken` module for verifying and creating JWTs
